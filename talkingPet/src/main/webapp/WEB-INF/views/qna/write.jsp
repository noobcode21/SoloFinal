...
<link href="${pageContext.request.contextPath}/resources/css/qna/write.css" rel="stylesheet">
</head>

<body>
    <div class="v99_2">
        <div class="v89_985"></div>
        <form class="v91_6" method="post" action="/app/qna/write" enctype="multipart/form-data">
